...
TARGET_TAG=v0.0.29 \
/tmp/upstream-ops-upgrade-kit-v0.0.29/scripts/upgrade.sh
```
...
TARGET_TAG=v0.0.29 /tmp/upstream-ops-upgrade-kit-v0.0.29/scripts/upgrade.sh
```
