...
TARGET_TAG=v0.0.27 \
/tmp/upstream-ops-upgrade-kit-v0.0.27/scripts/upgrade.sh
```
...
TARGET_TAG=v0.0.27 /tmp/upstream-ops-upgrade-kit-v0.0.27/scripts/upgrade.sh
```
