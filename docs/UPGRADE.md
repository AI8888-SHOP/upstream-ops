...
TARGET_TAG=v0.0.33 \
/tmp/upstream-ops-upgrade-kit-v0.0.33/scripts/upgrade.sh
```
...
TARGET_TAG=v0.0.33 /tmp/upstream-ops-upgrade-kit-v0.0.33/scripts/upgrade.sh
```
