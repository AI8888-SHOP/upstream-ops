...
TARGET_TAG=v0.0.32 \
/tmp/upstream-ops-upgrade-kit-v0.0.32/scripts/upgrade.sh
```
...
TARGET_TAG=v0.0.32 /tmp/upstream-ops-upgrade-kit-v0.0.32/scripts/upgrade.sh
```
