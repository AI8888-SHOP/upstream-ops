...
TARGET_TAG=v0.0.18 \
/tmp/upstream-ops-upgrade-kit-v0.0.18/scripts/upgrade.sh
```
...
TARGET_TAG=v0.0.18 /tmp/upstream-ops-upgrade-kit-v0.0.18/scripts/upgrade.sh
```
