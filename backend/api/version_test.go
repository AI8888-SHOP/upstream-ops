...
func TestVersionEndpointReportsUpdate(t *testing.T) {
	...
	withGitHubReleaseServer(t, http.StatusOK, `{"tag_name":"v999.0.0","html_url":"https://github.com/AI8888-SHOP/upstream-ops/releases/tag/v999.0.0"}`)
...
func TestVersionEndpointReportsNoUpdate(t *testing.T) {
	...
	withGitHubReleaseServer(t, http.StatusOK, `{"tag_name":"`+global.VERSION+`","html_url":"https://github.com/AI8888-SHOP/upstream-ops/releases/tag/v`+global.VERSION+`"}`)
	resp := requestVersion(t)
