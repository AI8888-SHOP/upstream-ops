...
func (rt *Runtime) recordUsage(
	...
	item := &storage.GatewayUsageLog{
		...
		UpstreamResponseModel: meta.ResponseModel.Model,
		UpstreamModelMismatch: responseModelMismatch(upstreamModel, meta.ResponseModel.Model),
		UpstreamModelConflict: meta.ResponseModel.Conflict,
